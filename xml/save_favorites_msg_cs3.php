...
$data = file_get_contents("php://input");
//$data = '<event number="pisano" photographer="RyanSerpan" email="development@proimagesoftware.com" favs="697193.697194.697195.697196.697198.697199" others="Yes" lname="" fname="" cmnts="This%20is%20a%20test"/>';
$data = '<?xml version="1.0" encoding="iso-8859-1"?>'.$data;
$parser = new XMLParser($data, 'raw', 1);
$tree = $parser->getTree();
$code = $tree['EVENT']['ATTRIBUTES']['NUMBER'];
$photo = $tree['EVENT']['ATTRIBUTES']['PHOTOGRAPHER'];
$Favs = $tree['EVENT']['ATTRIBUTES']['FAVS'];
$Others = clean_variable($tree['EVENT']['ATTRIBUTES']['OTHERS'],true);
$Email = clean_variable($tree['EVENT']['ATTRIBUTES']['EMAIL'],true);
$LName = clean_variable($tree['EVENT']['ATTRIBUTES']['LNAME'],true);
$FName = clean_variable($tree['EVENT']['ATTRIBUTES']['FNAME'],true);
$FComm = clean_variable($tree['EVENT']['ATTRIBUTES']['CMNTS'],true);
switch($Others){
...
require_once($r_path.'xml/get_favorites_cs3.php'); ?>