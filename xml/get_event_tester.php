...
$data = '<event number="dspw" photographer="flyinghorse"></event>';
...
function buildImages(){
	global $cp_connection, $event_number2, $cookieName;
...
buildGroup(0, 1);
if(isset($_COOKIE[$cookieName])) echo '<group id="0" name="Favorites"></group>';
echo '</event>';
buildImages();
