<?
function send_email($senderaddress, $emailaddress, $emailsubject, $emailtext, $html = false, $body_url = false, $foot_url = false, $BCC = false, $Files = false, $File_name = false){
