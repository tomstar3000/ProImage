...
build_record_table('Daily_Reports', 'Daily Reports', '', '', false, '', '', '', $headers, $sortheaders, $records, $div_data, $drop_downs, $_SERVER['PHP_SELF']."?Path=".$pathing."&Sort=".$Sorting, 'Open', '', '', 0, 0, 0, '', '100%', '', '',$Rec_Style_1, $Rec_Style_2, $Rec_Style_3, $btn_add, $hdr_img, "Record_Drop_Down");
?>
</div>