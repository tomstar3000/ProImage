...
<table border="0" cellpadding="0" cellspacing="0" width="100%">
  ...
  <tr>
    ...
    <td width="80%"><?php if(!$is_enabled ){ echo $CFName." ".$CMInt." ".$CLName; } else { ?>
      <input type="text" name="First Name" id="First_Name" value="<?php echo $CFName; ?>" />
      <input type="text" name="Middle Int" id="Middle_Int" value="<?php echo $CMInt; ?>" size="3" maxlength="1" />
      <input type="text" name="Last Name" id="Last_Name" value="<?php echo $CLName; ?>" />
      <?php } ?>
	  &nbsp;</td>
  </tr> <tr>
  ...
  <tr>
    ...
    <td><?php if(!$is_enabled){ echo $CEmail; } else { ?>
      <input type="text" name="Email" id="Email" value="<?php echo $CEmail; ?>" />
      <?php } ?>
      &nbsp;</td>
  </tr>
</table>
