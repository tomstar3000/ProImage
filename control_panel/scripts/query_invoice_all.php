...
<?php
	...
	build_record_table('Invoices', 'Internal Invoices', 'Complete Invoice(s)', 'Complete', false, '', '', '', $headers, $sortheaders, $records, $div_data, $drop_downs,$_SERVER['PHP_SELF']."?is_info=true&cont=edit&info=invoice&Path=".$pathing."&Sort=".$Sorting, 'Edit', '', '', 0, 0, 0, '', '100%', '', '', $Rec_Style_1, $Rec_Style_2, $Rec_Style_3, $btn_add, $hdr_img, "Record_Drop_Down");
?>
</div>
<br clear="all" />
<div id="Div_Records">
<?php
	...
	build_record_table('On_Line_Invoices', 'On-Line Invoices', 'Complete Invoice(s)', 'Complete', false, '', '', '', $headers, $sortheaders, $records, $div_data, $drop_downs,"/member/invoice.php?aevnet=true", 'View', '', '_blank', 0, 0, 0, '', '100%', '', '', $Rec_Style_1, $Rec_Style_2, $Rec_Style_3, '', $hdr_img, "Record_Drop_Down");
?>
</div>