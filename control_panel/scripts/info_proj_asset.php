...
<?php if($is_enabled){  ?>
  ...
  <tr>
    ...
    <td width="80%"><input type="text" name="Name" id="Name" value="<?php echo $AName; ?>" /></td>
  </tr>
  <tr>
    <td><strong>Price:</strong></td>
    <td><input type="text" name="Price" id="Price" value="<?php echo $APrice; ?>" /></td>
  </tr>
</table>
