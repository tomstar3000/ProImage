...
if(isset($_POST['Controller']) && $_POST['Controller'] == "Delete") include $r_path.'scripts/del_web_press.php';
?>
<div id="Form_Header">
...
$get_records = mysql_query($query_get_records, $cp_connection) or die(mysql_error());
	...
	$div_data = false;
	$drop_downs = false;
	$headers[0] = "Press Header";
	$headers[1] = "Press Page";
	...
	build_record_5_table('Web_Press','Website Press',$headers,$sortheaders,$records,$div_data,$drop_downs,array(array('Delete Press','Delete','Delete',false)),false,'100%','0','0','0',false,false,$Rec_Style_1,$Rec_Style_2,$Rec_Style_3,$Rec_Style_4,$Rec_Style_5);
