...
<table border="0" cellpadding="0" cellspacing="0" width="100%">
  ...
  <tr>
    <th colspan="2" id="Form_Header"><div id="Add"> <img src="/<?php echo $AevNet_Path; ?>/images/back.jpg" width="72" height="33" alt="back" onclick="javascript:set_form('form_','<?php echo implode(",",array_slice($path,0,4)); ?>','<?php echo $is_back; ?>','<?php echo $sort; ?>','<?php echo $rcrd; ?>');" /> </div>
      ...
      <p>Representative Information</p></th>
  </tr>
  <?php } else { ?>
  <tr>
  ...
  <tr>
    ...
    <td width="80%"><?php if(!$is_enabled){ echo $RFName." ".$RMInt." ".$RLName; } else { ?>
      <input type="text" name="First Name" id="First_Name" value="<?php echo $RFName; ?>" />
      <input type="text" name="Middle Int" id="Middle_Int" value="<?php echo $RMInt; ?>" size="3" maxlength="1" />
      <input type="text" name="Last Name" id="Last_Name" value="<?php echo $RLName; ?>" />
      <?php } ?>
      &nbsp;</td>
  </tr>
  <tr>
  ...
  <tr>
    ...
    <td><?php if(!$is_enabled){ echo $REmail; } else { ?>
      <input type="text" name="Email" id="Email" value="<?php echo $REmail; ?>" />
      <?php } ?>
      &nbsp;</td>
  </tr>
</table>
