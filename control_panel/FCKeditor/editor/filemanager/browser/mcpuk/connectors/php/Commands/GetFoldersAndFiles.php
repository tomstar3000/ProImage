...
<Connector command="GetFoldersAndFiles" resourceType="<? echo $this->type; ?>">
	<CurrentFolder path="<? echo $this->raw_cwd; ?>" url="<? echo $this->fckphp_config['urlprefix'] . $this->actual_cwd; ?>" />
	<Folders>
<?
			$files=array();
