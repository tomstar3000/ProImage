...
class GetUploadProgress {
	...
	function run() {
		...
		?>
<Connector command="GetUploadProgress" resourceType="<? echo $this->type; ?>">
	<CurrentFolder path="<? echo $this->raw_cwd; ?>" url="<? echo $this->actual_cwd; ?>" />
...
<Connector command="GetUploadProgress" resourceType="<? echo $this->type; ?>">
	<CurrentFolder path="<? echo $this->raw_cwd; ?>" url="<? echo $this->actual_cwd; ?>" />
	<Progress max="<? echo $totalBytes; ?>" value="<? echo $readBytes; ?>" />
	<RefreshURL url="<? echo htmlentities($refreshURL); ?>" />
</Connector>
		<?
