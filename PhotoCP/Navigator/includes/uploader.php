...
<html xmlns="http://www.w3.org/1999/xhtml">
    <head>
        ...
        <script src="/Aurigma/v_8.0.96/aurigma.uploader.js" type="text/javascript"></script>
        <script src="/Aurigma/v_8.0.96/aurigma.uploader.installationprogress.js" type="text/javascript"></script>
        <script src="/Aurigma/v_8.0.96/script.js" type="text/javascript"></script>
    ...
    <body>
            ...
            <div id="Records">
                <p>
                    ...
                    if (eregi('MSIE', strtoupper($_SERVER['HTTP_USER_AGENT']))) {
                        ?>
                        Notice that we are using Aurigma 8.0<br />
               ...
               <!--  <p>Having issues, use the previous version of the uploader <a href="<? echo $NavFolder; ?>/includes/uploader_7-0.php?data=<? echo $_GET['data']; ?>&fid=<? echo $_GET['fid']; ?>" title="Use the previous version of the uploader">here</a></p> -->
        ...
        <div id="HdrLinks600">
            ...
            <!-- <a href="#" onClick="imageUploader1.Refresh();return false;" class="BtnLoadRefresh">Refresh</a> -->
            <a href="#" onClick="$au.uploader('ImageUploader1').upload(); return false;" class="BtnLoadUpload" title="Upload images to the server">Upload</a>
            <a href="#" onClick="$au.uploader('ImageUploader1').folderPane().deselectAll(); return false;" class="BtnLoadDeselAll" title="Deselect all images">Deselect All</a>
            <a href="#" onClick="$au.uploader('ImageUploader1').folderPane().selectAll(); return false;" class="BtnLoadSelAll" title="Select all images">Select All</a>
            <a href="<? echo $NavFolder; ?>/includes/index.php?data=<? echo $_GET['data']; ?>" class="BtnLoadBack" title="Back to organizer">Back to organizer</a></div>
        ...
        <div id="LoaderWindow">
            ...
            id: 'ImageUploader1',
                    ...
                    //licenseKey: '76FF1-00119-73D83-A8F39-90B3E-698371', // Active 7.x
                    //licenseKey: '76FF1-00119-73D80-0003A-8F464-9D904A', // Active 8.x
                    licenseKey: '76FF1-00119-73D80-00068-91877-E43C19', // Active 8.0.5.x
...
<? } ?>
            activeXControl: {
            codeBase: '/Aurigma/v_8.0.96/Uploader8.cab',
                    codeBase64: '/Aurigma/v_8.0.96/Uploader8_x64.cab'
            },
                    javaControl: {
            codeBase: '/Aurigma/v_8.0.96/Uploader8.jar'
            },
                    uploadSettings: {
            actionUrl: '<? echo $NavFolder; ?>/xml/save_image.php?fid=<? echo $fid; ?>&event=<? echo base64_encode($EvntID); ?>&time=<?
$time = time();
echo $time;
?>',
...
<? } ?>
            ...
            hoursText: "Hour",
                    ...
                    ip.progressImageUrl('/Aurigma/v_8.0.96/Images/installation_progress.gif');
