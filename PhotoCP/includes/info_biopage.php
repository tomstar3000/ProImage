...
$HotMenu = "Web,Bio:query"; $Key = array_search($HotMenu, $StrArray); ?>

<h1 id="HdrType2" class="WebBio">
  <div>Bio Page Information</div>
</h1>
<div id="HdrLinks"> <a href="#" onclick="javascript:<? echo $onclick; ?> return false;" onmouseover="window.status='Save Bio Page Information'; return true;" onmouseout="window.status=''; return true;" title="Save Bio Page Information" class="BtnSave2">Save</a><a href="javascript:HotMenu('<? echo $HotMenu; ?>',<? echo ($Key!==false)?'2':'1'; ?>);" title="Add to Hot Menu" onmouseover="window.status='Add to Hot Menu'; return true;" onmouseout="window.status=''; return true;" class="BtnHotMenu<? echo ($Key!==false)?'Added':''; ?>" id="BtnHotMenu">Add to Hot Menu</a></div>
<div id="RecordTable" class="White">
  ...
  <div id="Records">
    <p>Bio Image:
      ...
      <? if($Iconv != ""){?>
      &nbsp;<a href="<? echo "/photographers/".$CHandle; ?>/<? echo $Iconv;?>" target="_blank">View</a>
      <? } ?>
      135 x 135 Pixel Dimensions</p>
  </div>
</div>
<div id="TinyMCE">
  <div class="TinyMCE">
