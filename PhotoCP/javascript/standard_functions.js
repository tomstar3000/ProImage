...
function AEV_GetState(ID,STATE,TAB,PREFIX){
	...
	xmlHttp.open('get',url); xmlHttp.onreadystatechange = function (){ AEV_GetStateLoaded(ID,STATE,TAB,PREFIX); }; xmlHttp.send(''); }
function AEV_GetStateLoaded(ID,STATE,TAB,PREFIX){ // Start building Folders
	$SelectBox = false; if (xmlHttp.readyState==4){ var xmlDoc=xmlHttp.responseXML.documentElement; // Get XML information
	...
	} else HTML = '<input name="'+PREFIX+'State" type="text" id="'+PREFIX+'State" tabindex="'+TAB+'" value="'+STATE+'" size="3" onfocus="javascript:this.className=\'CstmFrmElmntInputi34NavSel\';" onblur="javascript:this.className=\'CstmFrmElmntInputi34\';" onmouseover="window.status=\'State\'; return true;" onmouseout="window.status=\'\'; return true;" title="State" class="CstmFrmElmntInputi34" />';
