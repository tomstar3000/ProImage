...
var axVERSION = '8.0.54.0', jVERSION = '8.0.54.0';
var uploaderClassID = '1A5B2479-832B-484A-9401-F484998F63E7', uploaderProgID = 'Aurigma.Uploader.8054.1';
var thumbnailClassID = '376156F0-E079-485E-8167-291A145C0CF6', thumbnailProgID = 'Aurigma.Thumbnail.8054.1';
...
AU.fileAccessChecker.prototype.onJavaAfterCloseTagRender = function (uploader, args) {
    if (browser.isMac && browser.isSafari) {
        ...
        html.push(uploader.messages().noFileSystemAccessInSafari());
...
AU.fileAccessChecker.prototype.onJavaBeforeOpenTagRender = function (uploader, args) {
    if (browser.isMac && browser.isSafari) {
        args.resultHtml = "<div id='" + uploader.id() + "-checker'>";
    }
};
AU.debug = function () {
    ///	<summary>
...
AU.messages = function () {
    ...
    this._noFileSystemAccessInSafari = '<p>The browser does not allow Upload Suite to access the local file system. To enable the access perform the following steps:</p>' +
        '<ul>' + 
        '<li style="margin-top:10px">Go to <b>Safari</b>&rarr;<b>Preferences</b>, choose the <b>Security</b> tab, and click <b>Manage Website Settings</b>.</li>' +
        '<li style="margin-top:10px">Select <b>Java</b> in the left column, click on the dropdown box next to the appropriate website, and choose <b>Run in Unsafe Mode</b>.</li>' + 
        '</ul>';
}
