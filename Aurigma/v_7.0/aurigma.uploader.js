(function(window, undefined) {
    var axVERSION = '7.0.15.0', jVERSION = '7.0.15.0';
    var uploaderClassID = 'F3DCFC89-8C6E-4052-9176-B7806D188FD5', uploaderProgID='Aurigma.Uploader.7017.1';
    var thumbnailClassID = '9CC6A59F-9844-4AAE-ACC8-20E7AA3AFEF9', thumbnailProgID = 'Aurigma.Thumbnail.7017.1';
var 
// Global entry
    ...
    createMethod: function (obj, method) {
        ...
        obj[method.name] = function () {
            ...
            switch (arg.length) {
                ...
                case 1:
                    return element[controlMethodName](arg[0]);
                case 2:
                    return element[controlMethodName](arg[0], arg[1]);
                case 3:
                    return element[controlMethodName](arg[0], arg[1], arg[2]);
                case 4:
                    return element[controlMethodName](arg[0], arg[1], arg[2], arg[3]);
                case 5:
                    return element[controlMethodName](arg[0], arg[1], arg[2], arg[3], arg[4]);
                default:
                    // use eval :(
            ...
            if (!property.isAttribute) {
                (function (property) {
                    ...
                    converter[property.name] = function () {
                        if (arguments.length > 0) {
                            if (arguments[0] != null) {
                                element[setter](this._index, arguments[0]);
                            }
                        } else
                            return element[getter](this._index);
                    }
...
AU.file.reinit = function (element, obj) {
    ...
    obj.focused = function () {
        return element.getUploadFileFocused(this._index);
    };
    obj.format = function () {
        return element.getUploadFileFormat(this._index);
    };
    obj.guid = function () {
        return element.getUploadFileGuid(this._index);
    };
    obj.height = function () {
        return element.getUploadFileHeight(this._index);
    };
    obj.horizontalResolution = function () {
        return element.getUploadFileHorizontalResolution(this._index);
    };
    obj.name = function () {
    ...
    obj.tag = function (tag) {
        if (tag !== undefined) {
            element.setUploadFileTag(this._index, tag);
        } else {
            return element.getUploadFileTag(this._index);
        }
    };
    obj.type = function () {
        return element.getUploadFileType(this._index);
    };
    obj.verticalResolution = function () {
        return element.getUploadFileVerticalResolution(this._index);
    };
    obj.width = function () {
...
AU.files.reinit = function (obj) {
    ...
    obj.totalFileSize = function () {
        return element.getTotalFileSize();
    };
...
AU.metadata.reinit = function (obj) {
    ...
    obj.addCookie = function (value) {
        if (typeof element.AddCookie == undefinedStr) {
            showError('Method AddCookie does not exists.');
            return;
        }
        element.AddCookie(value);
    }

    obj.resetCookie = function () {
        if (typeof element.ResetCookie == undefinedStr) {
            showError('Method ResetCookie does not exists.');
            return;
        }
        element.ResetCookie();
    }

    //add cookies from internal array to control
    if (obj._cookies != null) {
        obj.addCookie(obj._cookies);
    }
