...
baseControl.prototype = {
	...
	_getHtmlHtml: function () {
		...
		var func = '__' + self.id() + '_initFunction' + suffix;
		...
		// render function.
		return '<div id="' + id + '"></div><img src="fkproto://img" onerror="' + func + '();" />';
	},
...
AU.converter.prototype = {
    ...
    thumbnailWatermark: function (value) {
        ///	<summary>
        ///		Get or set thumbnail watermark options
        ///	</summary>
        ///	<param name="value" type="String" />
        ///	<returns type="String" />
        /* will be created while initialization */
...
extend(AU.events.prototype, {
    _eventNames: [undefined /*base event*/, undefined /*base event*/, 'beforeUpload', 'afterUpload', 'beforePackageUpload',
        'afterPackageUpload', 'progress', 'error', 'restrictionFailed', 'itemsAdded', 'trace', 'uploadFileCountChange'],
...
AU.file.reinit = function (control, obj, type) {
    ...
    if (type == 'html') {
        ...
        obj.height = function () {
            return control.getUploadFileHeight(this._index);
        };
        obj.guid = function () {
        ...
        obj.width = function () {
            return control.getUploadFileWidth(this._index);
        };
        obj.remove = function () {
        ...
        obj.remove = function () {
            return control.callFlash("removeAt", this._index);
        };
...
AU.files.reinit = function (obj) {
    ...
    if (type === 'html') {
        ...
        obj.remove = function (index) {
            return control.uploadFileRemoveAt(index);
        };
    } else if (type === 'flash') {
        obj.count = function () {
    ...
    obj.remove = function (index) {
            return control.callFlash("removeAt", index);
    };
    } else {
        throw new Error('Not supported: ' + type);
    }
