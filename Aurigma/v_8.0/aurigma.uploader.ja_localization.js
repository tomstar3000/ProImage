...
AU.ip_language.ja = {
    ...
    "flashProgressHtml": "<p><img src=\"{0}\" /><br />Aurigma Upload Suite をロード中...</p>",
    ...
    "installFlashPlayerHtml": "<p>Aurigma Flash Uploaderを動作させるには、Flash Player のインストールが必要です。 最新版のダウンロードは<a href='http://www.adobe.com/go/getflashplayer' title='Download Flash Player'>ここから</a>できます。</p>"
};
})(window);
