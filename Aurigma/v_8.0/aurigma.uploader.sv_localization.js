...
AU.ip_language.sv = {
    ...
    "flashProgressHtml": "<p><img src=\"{0}\" /><br />Laddar Aurigma Upload Suite...</p>",
    ...
    "installFlashPlayerHtml": "<p>Du måste installera Flash Player för att kunna köra Aurigma Upload Suite. Hämta den senaste versionen <a href='http://www.adobe.com/go/getflashplayer' title='Download Flash Player'>här</a>.</p>"
};
})(window);
