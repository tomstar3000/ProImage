...
AU.ip_language.ru = {
    ...
    "flashProgressHtml": "<p><img src=\"{0}\" /><br />Загружается Aurigma Upload Suite...</p>",
    ...
    "installFlashPlayerHtml": "<p>Для запуска Aurigma Upload Suite необходимо установить Flash Player. Установите последнюю версию Flash Player <a href='http://www.adobe.com/go/getflashplayer' title='Скачать Flash Player'>отсюда</a>.</p>"
};
})(window);
