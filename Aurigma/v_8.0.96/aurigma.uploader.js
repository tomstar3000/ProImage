...
var axVERSION = '8.0.96.0', jVERSION = '8.0.96.0';
var uploaderClassID = '7F5E5D40-5FFB-4C0F-8C2D-BC5DAB655165', uploaderProgID = 'Aurigma.Uploader.8096.1';
var thumbnailClassID = '06FE0FCC-D6F4-49D6-856C-12CC8D495BF8', thumbnailProgID = 'Aurigma.Thumbnail.8096.1';
...
AU.messages = function () {
    ...
    this._noFileSystemAccessInSafari = '<p>The browser does not allow Upload Suite to access the local file system. To enable the access perform the following steps:</p>' +
        ...
        '<li style="margin-top:10px">Select <b>Java</b> in the left column, click on the dropdown box next to the <b>[name]</b> website, and choose <b>Run in Unsafe Mode</b>.</li>' + 
        '</ul>';
}
